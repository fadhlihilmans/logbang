...
<head>
    ...
    <title>Login - Dark Lightning</title>
    ...
    <style>
        ...
        h2 {
            ...
            letter-spacing: 2px;
            text-shadow: 2px 2px 0px #dc3545;
        }
    </style>
</head>
<body>
    ...
    <div class="login-card">
        <div class="text-center mb-4">
            <h2 class="fw-bold">Sistem Login</h2>
        ...
        <form action="{{ route('login.post') }}" method="POST">
            ...
            <div class="mb-3">
                <label for="email" class="form-label text-danger fw-bold">Alamat Email</label>
                <input type="email" class="form-control" id="email" name="email" placeholder="nama@email.com" required>
            </div>

            <div class="mb-4">
                <label for="password" class="form-label text-danger fw-bold">Kata Sandi</label>
        ...
        <div class="text-center mt-3">
            <small class="text-secondary">Belum punya akun? <a href="{{ route('register') }}" class="text-danger">Daftar Sekarang</a></small>
        </div>
    </div>
